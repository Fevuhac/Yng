...
Source Server         : linyng
Source Server Version : 50719
Source Host           : localhost:3306
Source Database       : fishjoy

Target Server Type    : MYSQL
Target Server Version : 50719
File Encoding         : 65001

Date: 2017-10-17 13:23:39
*/
...
CREATE TABLE `tbl_account` (
  ...
  `free_draw` text COMMENT '剩余免费抽奖次数, 需要每日重置({"gold":1,"diamond":0})',
...
-- ----------------------------
-- Table structure for tbl_account_server
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_account_sign
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_admin_auth
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_ai_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_aquarium
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_bind_log
-- ----------------------------
...
CREATE TABLE `tbl_bind_log` (
  ...
  `log_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录log的时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_cd_key
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_change_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_channel_create
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_channel_login
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_daily_statistics
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_drop_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_drop_serverlimit
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_exp_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_goddess
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_gold_log
-- ----------------------------
...
CREATE TABLE `tbl_gold_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=132424 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_gold_log_0
-- ----------------------------
DROP TABLE IF EXISTS `tbl_gold_log_0`;
CREATE TABLE `tbl_gold_log_0` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `account_id` bigint(20) NOT NULL COMMENT '账户ID',
  `log_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录日志的时间',
  `gain` int(11) NOT NULL DEFAULT '0' COMMENT '获得金币数',
...
-- ----------------------------
-- Table structure for tbl_gold_log_1
-- ----------------------------
DROP TABLE IF EXISTS `tbl_gold_log_1`;
CREATE TABLE `tbl_gold_log_1` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `account_id` bigint(20) NOT NULL COMMENT '账户ID',
  `log_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录日志的时间',
  `gain` int(11) NOT NULL DEFAULT '0' COMMENT '获得金币数',
  ...
  `level` int(11) NOT NULL DEFAULT '1' COMMENT '玩家当前等级',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=131637 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_gold_log_2
-- ----------------------------
DROP TABLE IF EXISTS `tbl_gold_log_2`;
CREATE TABLE `tbl_gold_log_2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `account_id` bigint(20) NOT NULL COMMENT '账户ID',
  `log_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录日志的时间',
  `gain` int(11) NOT NULL DEFAULT '0' COMMENT '获得金币数',
...
-- ----------------------------
-- Table structure for tbl_link_log
-- ----------------------------
...
CREATE TABLE `tbl_link_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30046374 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_link_log_0
-- ----------------------------
DROP TABLE IF EXISTS `tbl_link_log_0`;
CREATE TABLE `tbl_link_log_0` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `uid` bigint(20) NOT NULL COMMENT '用户ID, 用户调用任意API都会记录到这个表',
  `linked_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录的时间戳，由批量写入主动更新',
  `api` int(11) NOT NULL COMMENT '调用API, 需要一个对应表来转换',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30046849 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_link_log_1
-- ----------------------------
DROP TABLE IF EXISTS `tbl_link_log_1`;
CREATE TABLE `tbl_link_log_1` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `uid` bigint(20) NOT NULL COMMENT '用户ID, 用户调用任意API都会记录到这个表',
  `linked_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录的时间戳，由批量写入主动更新',
  `api` int(11) NOT NULL COMMENT '调用API, 需要一个对应表来转换',
...
-- ----------------------------
-- Table structure for tbl_link_log_2
-- ----------------------------
DROP TABLE IF EXISTS `tbl_link_log_2`;
CREATE TABLE `tbl_link_log_2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `uid` bigint(20) NOT NULL COMMENT '用户ID, 用户调用任意API都会记录到这个表',
  `linked_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '记录的时间戳，由批量写入主动更新',
  `api` int(11) NOT NULL COMMENT '调用API, 需要一个对应表来转换',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30048426 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_link_sum
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_logout_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_pearl_log
-- ----------------------------
...
CREATE TABLE `tbl_pearl_log` (
  ...
  `nickname` tinyint(1) NOT NULL DEFAULT '0' COMMENT '玩家是否为昵称账户的标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38925 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Table structure for tbl_propose
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_rankgame
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_rankgame_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_shop_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_skill_log
-- ----------------------------
...
CREATE TABLE `tbl_skill_log` (
  ...
  `nickname` tinyint(1) NOT NULL DEFAULT '0' COMMENT '玩家是否为昵称账户的标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=883164 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for tbl_stat_day
-- ----------------------------
...
-- ----------------------------
-- Table structure for tbl_stat_hour
-- ----------------------------
...
CREATE TABLE `tbl_stat_hour` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8996 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for tbl_weapon_log
-- ----------------------------
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `test`(IN `id` bigint,IN `points` int,IN `rank` int)
BEGIN
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `testProc`(IN `id` bigint,IN `points` int,IN `rank` int)
...
-- ----------------------------
-- Procedure structure for testProc1
-- ----------------------------
DROP PROCEDURE IF EXISTS `testProc1`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `testProc1`(IN `id` bigint,IN `points` int,IN `rank` int)
create table user_profile
(
    uid int auto_increment,
    stuName varchar(1000) not null,
