...
MySQL - 5.6.21-log : Database - fishjoy
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fishjoy` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `tbl_account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69922 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_ai_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21798 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_drop_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149867 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_gold` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14543 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_gold_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=131562 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_link_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30046324 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_login_log` (
  ...
  `nickname` tinyint(1) NOT NULL DEFAULT '0' COMMENT '玩家是否为昵称账户的标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30866 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_pearl_log` (
  ...
  `nickname` tinyint(1) NOT NULL DEFAULT '0' COMMENT '玩家是否为昵称账户的标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38694 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_skill_log` (
  ...
  `nickname` tinyint(1) NOT NULL DEFAULT '0' COMMENT '玩家是否为昵称账户的标识',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=882758 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_stat_hour` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8938 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_weapon_log` (
  ...
  `vip_weapon_id` varchar(64) DEFAULT NULL COMMENT 'VIP专属炮台ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8084 DEFAULT CHARSET=utf8;
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `GreetWorld`( )
