module.exports = {
    ...
    TABLE:{
        ...
        12:{
            name:'tbl_gold_log',
            field:['account_id', 'log_at', 'gain', 'cost', 'total', 'duration', 'scene', 'nickname', 'level'],
        },
        13:{
            name:'tbl_link_log',
            field:['uid', 'linked_at', 'api', 'id', 'id', 'uid', 'linked_at', 'api', 'id', 'id', 'uid', 'linked_at', 'api', 'id', 'id', 'uid', 'linked_at', 'api'],
        },
    }
