...
var _errorObj = {
    ...
    UID_CANNOT_FIND: { code: _errorCode.UID_CANNOT_FIND, msg: "用户ID无法找到" },
    ...
    RANKGAME_EMPTY_BOX: { code: _errorCode.RANKGAME_EMPTY_BOX, msg: "当前位置的宝箱是空的" },
    RANKGAME_LOCKED: { code: _errorCode.RANKGAME_LOCKED, msg: "当前位置的宝箱还没有解锁" },
    RANKGAME_NO_1ST_WIN_BOX: { code: _errorCode.RANKGAME_NO_1ST_WIN_BOX, msg: "玩家没有首胜宝箱" },
    ...
    // 订单相关
    ORDER_CREATE_FAIL: { code: _errorCode.ORDER_CREATE_FAIL, msg: "订单生成失败" },
    
    DATA_NULL_ERROR: { code: _errorCode.DATA_NULL_ERROR, msg: "数据为空:" },

    //聊天
    CHAT_COST_ERROR: { code: _errorCode.CHAT_COST_ERROR, msg: "钻石喇叭不足" },
    CHAT_FRIEND_ERROR: { code: _errorCode.CHAT_FRIEND_ERROR, msg: "好友请求已经发送过了" },
    CHAT_REWARD_ERROR: { code: _errorCode.CHAT_REWARD_ERROR, msg: "今日已打赏过该物品，不能重复打赏" },
    CHAT_REWARD_LESS_ERROR: { code: _errorCode.CHAT_REWARD_LESS_ERROR, msg: "物品不足" },
    CHAT_FRIEND_ALREADY_ERROR: { code: _errorCode.CHAT_FRIEND_ALREADY_ERROR, msg: "已经是好友了" },
    CHAT_FRIEND_GAME_ERROR: { code: _errorCode.CHAT_FRIEND_GAME_ERROR, msg: "删除好友失败，对方可能是你的qq好友" },
};
