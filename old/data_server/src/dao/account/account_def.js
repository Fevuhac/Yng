...
function _getGoddessInitData() {
    ...
    if (ret.length > 0) {
        ret[0].level = 1;
        ret[0].unlock = [2, 2, 2, 2, 2, 2, 2, 2, 2];
    }
    return ret;
}
var _goddessInitData = _getGoddessInitData();
var _charmDefault = CharmUtil.getNewAccountCharmPointDefault();
