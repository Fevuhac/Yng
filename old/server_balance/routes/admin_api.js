...
const PATH_ROUTES_ADMIN= '../routes/admin/';

// var StringUtil = require('../src/utils/StringUtil');
var admin_server = require(PATH_ROUTES_ADMIN + 'admin_server');
var admin_operation = require(PATH_ROUTES_ADMIN + 'admin_operation');
...
//------------------------------------------------------------------------------
// 服务器更新重启
router.post('/shutdown_by_update', function (req, res) {
    admin_server.shutdownByUpdate(req, res);
});
