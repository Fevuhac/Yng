...
const DATA_SERVER_ADDRESS = "192.168.35.211";
const DATA_SERVER_PORT = 1337;

const CHAT_SERVER_ADDRESS = "192.168.35.211";
const CHAT_SERVER_PORT = 5001;

const BALANCE_SERVER_ADDRESS = "192.168.35.211";
const BALANCE_SERVER_PORT = 1338;

const SERVER_POOL_ADDRESS = "192.168.35.211"
const SERVER_POOL_SOCKET_PORT = 4747

const RESOURCE_SERVER_ADDRESS = "192.168.35.211"
const RESOURCE_SERVER_PORT = 6700

const FIGHTING_SERVER_ADDRESS = "192.168.35.211"
